...
import eqipped from "/public/careers/eqipped.webp"
import enkarma from "/public/careers/enkarma.png"
import fundingCenter from "/public/careers/fundingCenter.png"
import coreops from "/public/careers/coreops.png"
import collab from "/public/careers/collab.jpg"
import whitebunnie from "/public/careers/whitebunnie.svg"

const clients = [
    { name: 'Empowering Workers', icon: eqipped },
    { name: 'Digital India', icon: enkarma },
    { name: 'Viksit Bharat', icon: fundingCenter },
    { name: 'Unity and Strength', icon: coreops },
    { name: 'Skill India', icon: collab },
    { name: 'Stand-Up India', icon: whitebunnie },
]

export default function GovSchemeLogoCareers() {
